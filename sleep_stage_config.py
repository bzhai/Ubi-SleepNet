...
class Config(object):
    def __init__(self):
        ...
        if platform.uname()[1] == 'BB-WIN8':
            self.HR_PATH = "Dataset/annotations-rpoints"
            self.ACC_PATH = "Dataset/actigraphy"
            self.OVERLAP_PATH = "Dataset/mesa-actigraphy-psg-overlap.csv"
            self.HRV30_ACC_STD_PATH = "Dataset/HRV30s_ACC30s_H5/std/hrv30s_acc30s_full_feat_stand.h5"
            self.NN_ACC_HRV_STD = "Dataset/HRV30s_ACC30s_H5/std/nn_acc_hrv30s_%d.h5"
            self.MESA_ACC_HR_STATISTICS_STD_DATA_PATH = "Dataset/HR_STATISTIC30s_ACC30s_H5/hr_statistic_30s_acc30s_full_feat_stand.h5"
            self.MESA_NN_ACC_HR_STATISTIC = "Dataset/HR_STATISTIC30s_ACC30s_H5/nn_acc_hr_statistic_30s_%d.h5"
            self.MESA_ACC_HR_STATISTIC_CSV_ALIGNED = "Dataset/Aligned_ACC_HR_STATISTIC_CSV"
            self.MESA_ACC_HR_STATISTIC_FEATURE = "Dataset/mesa_acc_hr_statistic_feature_list.csv"
            ...
            self.APPLE_LOOCV_PID_PATH = r"assets/apple_16_fold.csv"
