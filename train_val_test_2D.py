...
from models.build_2dmodel import build_2d_model, get_num_in_channel
...
def main(args):
    ...
    for fold_num in np.arange(total_folds):
        model = build_2d_model(args.nn_type, args.dataset, args.num_classes, args.seq_len)
        ...
        summary(model, (1, get_num_in_channel(args.dataset),  int(args.seq_len)+1))  # print the model summary
        train_loader, test_loader, val_loader = \
            get_windowed_train_test_val_loader_2D(cfg=cfg, batch_size=args.batch_size, seq_len=args.seq_len,
...
def parse_arguments(argv):
    ...
    parser.add_argument('--nn_type', type=str, default="VggIMG",
    ...
    parser.add_argument('--seq_len', type=int, default=50, help="100, 50, 20")
