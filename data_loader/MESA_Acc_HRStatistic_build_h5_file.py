...
if __name__ == '__main__':
    config = Config()
    builder = H5DatasetBuilder(csv_path=config.MESA_ACC_HR_STATISTIC_CSV_ALIGNED,
                               output_path_name=config.MESA_ACC_HR_STATISTICS_STD_DATA_PATH,
                               feat_list_path=config.MESA_ACC_HR_STATISTIC_FEATURE, pre_split=config.TRAIN_TEST_SPLIT)
